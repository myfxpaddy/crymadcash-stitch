...
export function StitchScreen({ src, title }) {
    ...
    return (_jsxs("div", { className: "relative h-full w-full overflow-hidden", children: [!loaded && (_jsx("div", { className: "absolute inset-0 z-20 flex items-center justify-center bg-bg", children: _jsxs("div", { className: "font-mono text-[10px] uppercase tracking-[0.2em] text-primary", children: [_jsx("span", { className: "pulse-dot mr-2 inline-block align-middle" }), "Loading"] }) })), _jsx("iframe", { ref: iframeRef, src: src, title: title, onLoad: onIframeLoad, className: "absolute inset-0 z-10 h-full w-full border-0", sandbox: "allow-same-origin allow-scripts allow-forms allow-popups" }, src)] }));
}
